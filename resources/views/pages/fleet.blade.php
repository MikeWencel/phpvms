...
<div class="container py-5 text-light">
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        ...
        <div class="col">
            <div class="card h-100 bg-dark text-light shadow-lg border-0 hover-card">
                <div class="image-container">
                    <img src="{{ public_asset('/images/fleet/cj4.jpg') }}" class="card-img-top object-fit-cover img-hover-zoom" style="height: 220px;" alt="Cessna Citation CJ4">
        ...
        <div class="col">
            <div class="card h-100 d-flex flex-column bg-dark text-light shadow-lg border-0 hover-card">
                ...
                <div class="image-container order-2">
                    <img src="{{ public_asset('/images/fleet/longitude.jpg') }}" class="card-img-top object-fit-cover img-hover-zoom" style="height: 220px;" alt="Cessna Citation Longitude">
                    <div class="image-caption">Image courtesy of Textron Aviation - media.txtav.com</div>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card h-100 bg-dark text-light shadow-lg border-0 hover-card">
                <div class="image-container">
                    <img src="{{ public_asset('/images/fleet/citationx.jpg') }}" class="card-img-top object-fit-cover img-hover-zoom" style="height: 220px;" alt="Cessna Citation X">
                    <div class="image-caption">Image courtesy of Textron Aviation - media.txtav.com</div>
                </div>
                <div class="card-body">
