...
<section class="bg-dark text-white py-5 rounded-4">
    ...
    <div class="container">
        ...
        <div class="row mb-5 align-items-center g-4">
            ...
            <div class="col-md-6">
                <img src="{{ public_asset('/images/flightschool/cessna_day.jpg') }}" alt="VFR training" class="program-img rounded shadow">
            </div>
        </div>
        ...
        <div class="row mb-5 align-items-center g-4 flex-md-row-reverse">
            ...
            <div class="col-md-6">
                <img src="{{ public_asset('/images/flightschool/ils_approach_chart.png') }}" alt="IFR training" class="program-img rounded shadow">
            </div>
        </div>
        ...
        <div class="row mb-5 align-items-center g-4">
            ...
            <div class="col-md-6">
                <img src="{{ public_asset('/images/flightschool/fmc_a20n.png') }}" alt="Jet operations" class="program-img rounded shadow">
            </div>
        </div>
        ...
        <div class="row mb-5 align-items-center g-4 flex-md-row-reverse">
            ...
            <div class="col-md-6">
                <img src="{{ public_asset('/images/flightschool/vatsim_ui.jpg') }}" alt="VATSIM training" class="program-img rounded shadow">
            </div>
        </div>
