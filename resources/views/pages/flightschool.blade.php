...
<section class="bg-dark text-light rounded-4 overflow-hidden">
    <header class="text-center text-white" style="background-image: url('{{ public_asset('/images/flightschool/airbus_night.jpg') }}'); background-size: cover; background-position: center;">
    ...
    <section class="container py-5">
        <div class="row gy-4 text-light">
            <div class="col-md-4">
                <div class="card bg-black border-warning h-100">
                    <div class="ratio ratio-4x3">
                        <img src="{{ public_asset('/images/flightschool/cessna_day.jpg') }}" class="card-img-top object-fit-cover" alt="VFR training">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card bg-black border-warning h-100">
                    <div class="ratio ratio-4x3">
                        <img src="{{ public_asset('/images/flightschool/ils_approach_chart.png') }}" class="card-img-top object-fit-cover" alt="IFR training">
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card bg-black border-warning h-100">
                    <div class="ratio ratio-4x3">
                        <img src="{{ public_asset('/images/flightschool/fmc_a20n.png') }}" class="card-img-top object-fit-cover" alt="Jet procedures">
                    </div>
                    <div class="card-body">
